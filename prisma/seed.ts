...
async function main() {
  ...
  try {
    ...
    const commercialAdvisorPermissionMatrix = [
      { action: TypeAction.read, subject: TypeSubject.student },
      { action: TypeAction.read, subject: TypeSubject.room },
      { action: TypeAction.manage, subject: TypeSubject.inscription },
      { action: TypeAction.create, subject: TypeSubject.inscription },
      { action: TypeAction.update, subject: TypeSubject.inscription },
      { action: TypeAction.read, subject: TypeSubject.inscription },
      { action: TypeAction.delete, subject: TypeSubject.inscription },
      { action: TypeAction.manage, subject: TypeSubject.booking },
      { action: TypeAction.create, subject: TypeSubject.booking },
      { action: TypeAction.update, subject: TypeSubject.booking },
      { action: TypeAction.read, subject: TypeSubject.booking },
      { action: TypeAction.delete, subject: TypeSubject.booking },
      { action: TypeAction.manage, subject: TypeSubject.correspondence },
      { action: TypeAction.read, subject: TypeSubject.correspondence },
